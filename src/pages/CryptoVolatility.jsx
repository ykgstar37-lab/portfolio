...
function PaperViewer() {
    ...
    return (
        <motion.div id="paper" className="mb-20" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}>
            <h2 className="text-2xl sm:text-3xl font-bold mb-3 tracking-tight" style={{ fontFamily: "'Syne', sans-serif" }}>Paper</h2>
            <p className="text-gray-500 mb-6">완성된 논문 미리보기 — 화살표로 페이지를 넘겨보세요</p>
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div className="relative">
                    <img
