                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-white p-6 sm:p-8 rounded-2xl border border-gray-100 shadow-sm">
                            ...
                            <ul className="space-y-2 text-sm text-gray-600">
                                <li className="flex items-start gap-2"><span className="text-amber-500 mt-0.5">-</span><span>Reranker 도입 후 응답 속도 -1초 증가 — 정확도와의 트레이드오프를 사용자 관점에서 더 검토 필요</span></li>
                                <li className="flex items-start gap-2"><span className="text-amber-500 mt-0.5">-</span><span>사용자 피드백 수집 미구현 — RLHF 파이프라인이 있었으면 RAG 품질을 지속 개선할 수 있었을 것</span></li>
                                <li className="flex items-start gap-2"><span className="text-amber-500 mt-0.5">-</span><span>모니터링/로깅 부족 — 프로덕션에서 어떤 질문이 실패하는지 추적하는 체계가 없어 개선 방향을 잡기 어려웠음</span></li>
                            </ul>
                        </div>
                    </div>
                </motion.div>
