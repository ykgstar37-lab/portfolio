        ...
        <footer className="footer">
            <div className="footer__inner">
                ...
                <div className="footer__social">
                    ...
                    <a href="#" className="footer__social-link" aria-label="Copy Email"
                        onClick={(e) => {
                            e.preventDefault()
                    ...
                    <a href="https://www.notion.so/Portfolio-2c6bec2d3d51809ca4f2c7b1150ce12d?source=copy_link" target="_blank" rel="noopener noreferrer" className="footer__social-link" aria-label="Notion">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
